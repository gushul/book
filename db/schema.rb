...
ActiveRecord::Schema.define(version: 20141207182150) do
  ...
  add_index "inventory_template_groups", ["restaurant_id"], name: "index_inventory_template_groups_on_restaurant_id", using: :btree
  ...
  add_index "nicknames", ["restaurant_id"], name: "index_nicknames_on_restaurant_id", using: :btree
  ...
  add_index "notes", ["restaurant_id"], name: "index_notes_on_restaurant_id", using: :btree
  ...
  create_table "restaurants", force: true do |t|
    ...
    t.string   "meta_kw"
    t.string   "meta_desc"
    t.boolean  "instant_confirm",                                     default: true
  end
  ...
  add_index "vips", ["restaurant_id"], name: "index_vips_on_restaurant_id", using: :btree
